...
class CardMultilineWidget @JvmOverloads constructor(
    ...
    override fun onAttachedToWindow() {
        ...
        postalCodeEditText.config = PostalCodeEditText.Config.Global
        //cvcEditText.hint = null // Commented code to match AppStore UI
    }
    ...
    // Commented Code for Android AppStore UI changes which disables Floating PlaceHolder in EditText
